...
<footer class="rounded-div border-none p-4 sm:p-6">
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <Link to="/" class="flex items-center">
                <div className='h-10 w-10 bg-blue-900 rounded-full'></div>
        ...
        <div class="grid grid-cols-8 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div className='ml-16 sm:ml-8'>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    ...
                    <li className='mb-2'>
                        <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Telegram</a>
                    </li>
                    <li className=''>
